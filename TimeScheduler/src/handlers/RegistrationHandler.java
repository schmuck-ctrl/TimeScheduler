...
public class RegistrationHandler {
     ...
     *
     * @param inpassword The password that the user writes into the registration
     * window.
     ...
     *
     * @param inputPassword First password that the user writes into the
     * registration window.
     * @param repeatPassword Second password that the user writes into the
     * registration window.
    ...
    /**
     * Creates a new user object and stores him in the Database Password gets
     * encrypted and written into a string.
     *
    ...
    /**
     * Shows the user input windows, messages and checks if the verification
     * code is correct.
     *
    ...
    public boolean checkVerificationCode(String email) {
        ...
        LoggerHandler.logger.info("The entered Log in verification number was incorrect.");
        return false;
    }
